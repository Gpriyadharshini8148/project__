...
export const config: EnvironmentConfig = {
  urls: {
    ...
    sfTokenUrl: process.env.SF_TOKEN_URL || 'https://test.salesforce.com/services/oauth2/token',
    sfBaseUrl: process.env.SF_BASE_URL || process.env.ADMIN_URL || 'https://bajaj4--n2ppos.sandbox.my.salesforce.com',
  },
